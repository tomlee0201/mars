...
#define MESSAGE_CONTENT_TYPE_ADD_GROUP_MEMBER 5
#define MESSAGE_CONTENT_TYPE_KICKOF_GROUP_MEMBER 6
#define MESSAGE_CONTENT_TYPE_QUIT_GROUP 7
#define MESSAGE_CONTENT_TYPE_DISMISS_GROUP 8
